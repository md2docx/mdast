...
export interface Data extends UnistData {
  /**
   * Styles data compatible with docx - could be passed via inline or block html
   */
  border?: Mutable<IBorderOptions | IBordersOptions>;
 ...
 */
export interface RootContentMap extends PhrasingContentMap, BlockContentMap {
  definition: Definition;
  footnoteDefinition: FootnoteDefinition;
  listItem: ListItem;
  tableCell: TableCell;
